sap.ui.define([
	...
	return Controller.extend("com.dpz_Ten_Views_Task.controller.View5", {
		...
		iconDeleteBtn1:function(){
			...
			MessageBox.confirm("Are you sure you want to delete Selected Items?", {
                onClose: function (oAction) {
                    if (oAction === "OK") {
                    	for(var i = icontableSelected.length - 1; i >= 0; i--){
                    		 var oIconContext = icontableSelected[i].getBindingContext("TenDataModel");
                    		 var index = oIconContext.getPath().split("/").pop();
                    		 if(index >= 0){
                    		 	iconTabTable1.splice(index, 1);
                    		 }
                    	}
                    	oModel.refresh(true);
		...
		iconDeleteBtn2:function(){
			var iconTable2 = this.getView().byId("iconTable2Id");
			var oModel = this.getOwnerComponent().getModel("TenDataModel");
			var iconTabTable2 = oModel.getProperty("/iconEmployee2");
			var icontableSelected = iconTable2.getSelectedItems();
		...
		iconDeleteBtn3:function(){
			var iconTable3 = this.getView().byId("iconTable3Id");
			var oModel = this.getOwnerComponent().getModel("TenDataModel");
			var iconTabTable3 = oModel.getProperty("/iconEmployee3");
			var icontableSelected = iconTable3.getSelectedItems();
		...
		iconDeleteBtn4:function(){
			var iconTable4 = this.getView().byId("iconTable4Id");
			var oModel = this.getOwnerComponent().getModel("TenDataModel");
			var iconTabTable4 = oModel.getProperty("/iconEmployee4");
			var icontableSelected = iconTable4.getSelectedItems();
		...
		iconDeleteBtn5:function(){
			var iconTable5 = this.getView().byId("iconTable5Id");
			var oModel = this.getOwnerComponent().getModel("TenDataModel");
			var iconTabTable5 = oModel.getProperty("/iconEmployee5");
			var icontableSelected = iconTable5.getSelectedItems();
		...
		iconDeleteBtn6:function(){
			var iconTable6 = this.getView().byId("iconTable6Id");
			var oModel = this.getOwnerComponent().getModel("TenDataModel");
			var iconTabTable6 = oModel.getProperty("/iconEmployee6");
			var icontableSelected = iconTable6.getSelectedItems();
